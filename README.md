...
|---------|-------------|-----------|
| 🚀 **[JAVA-React-K8s-GitOps-Deployment](https://github.com/rajKumarDevOP/JAVA-React-K8s-GitOps-Deployment)** | Full-stack JAVA-React application deployment with GitOps on Kubernetes | `Kubernetes` `GitOps` `React` `Java` |
| 🔄 **[JAVA-WAR-CI-CD-Pipeline-GitHub-Actions-Nexus-Jenkins-Tomcat](https://github.com/rajKumarDevOP/JAVA-WAR-CI-CD-Pipeline-GitHub-Actions-Nexus-Jenkins-Tomcat)** | Complete CI/CD pipeline for Java WAR deployment via GitHub Actions, Nexus & Tomcat | `GitHub Actions` `Jenkins` `Nexus` `Tomcat` |
...
<a href="https://github.com/rajKumarDevOP">
  <img height="180em" src="https://github-readme-streak-stats.herokuapp.com/?user=rajKumarDevOP&theme=tokyonight" />
</a>
...
> I'm committed to continuous learning and staying updated with the latest DevOps trends and best practices.

**Currently Exploring:**
- 🔄 Advanced Kubernetes patterns & operators
- ☁️ Multi-cloud orchestration strategies  
...
[![Recent Activity Graph](https://activity-graph.herokuapp.com/graph?username=rajKumarDevOP&theme=xcode&hide_border=true&area=true)](https://github.com/rajKumarDevOP)
...
[![Visitor Badge](https://visitor-badge.laobi.icu/badge?page_id=rajKumarDevOP.rajKumarDevOP&left_color=00D9FF&right_color=FF006E)](https://github.com/rajKumarDevOP)
